...
package com.sree.oneapp.model.userdata

import com.sree.oneapp.model.SessionId
import com.sree.oneapp.model.reservations.ReservationRequest
import com.sree.oneapp.model.reservations.ReservationRequest.ReservationRequestEntityAction.CANCEL_REQUESTED
import com.sree.oneapp.model.reservations.ReservationRequest.ReservationRequestEntityAction.RESERVE_REQUESTED
import com.sree.oneapp.model.reservations.ReservationRequestResult
import com.sree.oneapp.model.reservations.ReservationRequestResult.ReservationRequestStatus.CANCEL_DENIED_CUTOFF
import com.sree.oneapp.model.reservations.ReservationRequestResult.ReservationRequestStatus.CANCEL_DENIED_UNKNOWN
import com.sree.oneapp.model.reservations.ReservationRequestResult.ReservationRequestStatus.CANCEL_SUCCEEDED
import com.sree.oneapp.model.reservations.ReservationRequestResult.ReservationRequestStatus.RESERVE_DENIED_CLASH
import com.sree.oneapp.model.reservations.ReservationRequestResult.ReservationRequestStatus.RESERVE_DENIED_CUTOFF
import com.sree.oneapp.model.reservations.ReservationRequestResult.ReservationRequestStatus.RESERVE_DENIED_UNKNOWN
import com.sree.oneapp.model.reservations.ReservationRequestResult.ReservationRequestStatus.RESERVE_SUCCEEDED
import com.sree.oneapp.model.reservations.ReservationRequestResult.ReservationRequestStatus.RESERVE_WAITLISTED
import com.sree.oneapp.model.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_DENIED_CLASH
import com.sree.oneapp.model.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_DENIED_CUTOFF
import com.sree.oneapp.model.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_DENIED_UNKNOWN
import com.sree.oneapp.model.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_SUCCEEDED
import com.sree.oneapp.model.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_WAITLISTED
