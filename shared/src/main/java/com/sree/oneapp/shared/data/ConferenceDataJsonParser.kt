...
import com.sree.oneapp.shared.data.session.json.RoomDeserializer
import com.sree.oneapp.shared.data.session.json.SessionDeserializer
import com.sree.oneapp.shared.data.session.json.SessionTemp
import com.sree.oneapp.shared.data.session.json.SpeakerDeserializer
import com.sree.oneapp.shared.data.session.json.TagDeserializer
